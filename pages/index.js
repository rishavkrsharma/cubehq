    ...
    <div className="bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-600/30 via-slate-900 to-black">
      ...
      <main>
        <div className="max-w-4xl mx-auto text-center py-20 px-4 sm:py-40 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-7xl font-semibold text-transparent bg-clip-text bg-gradient-to-br from-white via-slate-300 to-slate-600">
              <span className="block">Linear is a better way</span>
              <span className="block">to build products</span>
            </h2>
          </motion.div>
          ...
          >
            <p className="mt-10 text-2xl leading-6 text-slate-300">
        ...
        >
          <img
            className="relative rounded-lg shadow-2xl shadow-indigo-900"
